...
export type SnmpSecurity = "authPriv" | "authNoPriv" | "noAuthNoPriv";
...
export interface SubmittedAgentPlanAction {
  portId: string;
  actionKey: StrategyKey;
  rationale: string;
...
export interface SubmittedAgentPlan {
  summary: string;
  explanation: string;
  gateMode: "auto" | "manual";
  gateReason: string;
  selectedActions: SubmittedAgentPlanAction[];
}
